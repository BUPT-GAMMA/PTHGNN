...
if args.domain == '_CS':
    replace_edge_list = defaultdict( #target_type
    ...
    for target_type in graph.edge_list:
        for source_type in graph.edge_list[target_type]:
            for relation_type in graph.edge_list[target_type][source_type]:
                if relation_type == "PV_Repository" or relation_type == "rev_PV_Repository":
                    continue
                replace_edge_list[target_type][source_type][relation_type] = graph.edge_list[target_type][source_type][relation_type]

    graph.edge_list = replace_edge_list
    del replace_edge_list
else:
    replace_edge_list = defaultdict( #target_type
                            lambda: defaultdict(  #source_type
                                lambda: defaultdict(  #relation_type
    ...
    for target_type in graph.edge_list:
        for source_type in graph.edge_list[target_type]:
            for relation_type in graph.edge_list[target_type][source_type]:
                replace_edge_list[target_type][source_type][relation_type] = graph.edge_list[target_type][source_type][relation_type]
    replace_edge_list['paper']['venue']["PV_Repository"][0][0] = 2010
    replace_edge_list['paper']['venue']["rev_PV_Repository"][0][0] = 2010
    graph.edge_list = replace_edge_list
    del replace_edge_list
